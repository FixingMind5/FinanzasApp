...
//  PlatziFinanzas
//
//  Created by Manuel Alejandro Aguilar Tellez Giron on 12/30/18.
//  Copyright © 2018 Manuel Alejandro Aguilar Tellez Giron. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        TWTRTwitter.sharedInstance().start(
            withConsumerKey: "Pkq7AFXNTv1AdRPmiCBEehnD5",
            consumerSecret: "p3Vnq4X5Yqs0RWFkQT3wIY9JiQCWx15KAOWAgiZLf8rhBS1pQb")
